...
urlpatterns = [
    ...
    # Ruta para crear y editar módulos con preguntas
    path('cmodulos/', ModuloCreateUpdateAPIView.as_view(), name='crear_modulo'),
    path('modulos/<int:id_modulo>/', ModuloCreateUpdateAPIView.as_view(), name='editar_modulo'),

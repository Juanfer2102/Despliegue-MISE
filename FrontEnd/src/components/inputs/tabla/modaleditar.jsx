        ...
        <div className="flex flex-col gap-8">
          <div className="container flex-col bg-greyBlack rounded-xl gap-3 text-center p-5 flex justify-center items-start">
            ...
            <div className="flex flex-col justify-center items-center gap-6">
              ...
              <div className="flex flex-row items-center text-start content-center h-[4rem]">
                <p className="font-semibold text-textBg w-[10rem]">Modulo</p>
                <p className="w-[17rem] text-textBg font-semibold">Estrategia y dirección gerencial</p>
              </div>
              <div className="flex flex-row items-center text-start content-center h-[4rem]">
                <p className="font-semibold text-textBg w-[10rem]">Sueño</p>
                <p className="w-[17rem] text-textBg font-semibold">Definir propósito empresarial</p>
              </div>
              <div className="flex flex-row items-center text-start content-center h-[4rem]">
                <p className="font-semibold text-textBg w-[10rem]">Nivel</p>
                <p className="w-[17rem] text-textBg font-semibold">SUEÑOS EXPRESS</p>
          ...
          <div className="container flex-col bg-greyBlack rounded-xl gap-3 text-center p-5 flex justify-center items-start">
            ...
            <div className="flex flex-col justify-center items-center gap-6">
              <Input3 DataType="Pregunta" inputPlaceholder="Pregunta Modulo" inputType="text" height="h-10" width="w-[10rem]" widthInput="w-[15rem]" additionalClass="" />
              <Input3 DataType="Modulo" inputPlaceholder="Modulo Modulo" inputType="text" height="h-10" width="w-[10rem]" widthInput="w-[15rem]" additionalClass="" />
              <Input3 DataType="Sueño" inputPlaceholder="Sueño" inputType="text" height="h-10" width="w-[10rem]" widthInput="w-[15rem]" additionalClass="" />
              <Input3 DataType="Nivel" inputPlaceholder="Nivel" inputType="text" height="h-10" width="w-[10rem]" widthInput="w-[15rem]" additionalClass="" />
            </div>
          </div>
        </div>
      )}

...
const Dashboard = () => {
  return (
    <LayoutDashboard title="Dashboard">
      <main className="flex flex-col w-full bg-greyBlack h-full">
        <div className="flex flex-col w-full">
          ...
          <div className="bg-greyBg flex flex-col gap-8 px-4 sm:px-8 py-5 h-full w-full">
            <div className="flex flex-col lg:flex-row gap-10 h-full">
              <div className="flex flex-col px-10 justify-between gap-8">
                <Grafica />
                <div className="w-full pt-10 px-2 sm:px-5">
                  <TablasEmpresaporc />
                </div>
              </div>
              <div className="w-full lg:w-1/3 flex flex-col justify-between gap-2">

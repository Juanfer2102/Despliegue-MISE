    ...
    <LayoutDashboard title="Dashboard">
      <main className="bg-greyBg w-full h-screen overflow-x-hidden">
        <div className="flex flex-col w-full h-full">
          ...
          <div className="bg-greyBg flex flex-col py-2 xl:gap-5 lg:gap-5 w-full xl:h-full px-4 lg:px-12 xl:px-12 pt-4 xl:pt-6">
            ...
            <div className="flex flex-col xl:flex-row lg:flex-row xl:gap-[5rem] lg:gap-[5rem] gap-10">
              <div className="flex flex-row xl:flex-col lg:flex-col gap-5 w-full xl:w-[18rem] lg:w-[18rem] p-4 justify-start xl:justify-center lg:justify-center items-center lg:items-stretch xl:items-stretch bg-darkslategray text-white rounded-lg lg:max-h-[28rem] overflow-x-auto xl:overflow-y-auto lg:overflow-y-auto xl:overflow-x-hidden lg:overflow-x-hidden custom-scrollbar">
            ...
            <div className="flex flex-col xl:flex-row lg:flex-row gap-8 xl:justify-between">
              <TablaPreguntas />
              <ValidacionDeSueños />
            </div>
          </div>

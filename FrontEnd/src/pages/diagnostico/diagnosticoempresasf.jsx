                        ...
                        <div className="bg-greyBg flex flex-col py-2 xl:gap-5 lg:gap-5 gap-4 w-full xl:h-full px-4 lg:px-12 xl:px-12 pt-4 xl:pt-6">
                            <div className="flex flex-col justify-between pt-5">
                                <div className="flex justify-between">
                                    ...
                                    <button onClick={openModal} className='bg-principalGreen  hover:bg-white rounded-md text-white hover:text-principalGreen text-2xl text-center font-semibold cursor-pointer w-max h-max p-2'>
                                        Dar por finalizado
                                    </button>
                                </div>
